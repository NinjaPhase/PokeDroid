...
/**
 * <p>The {@code EnemyStatus} displays the enemy's
...
public class EnemyStatus {
	...
	/**
	 * <p>Constructs a new {@code EnemyStatus}.</p>
	 * 
	 * @param pokemon The enemy pokemon.
	 * @param font The bitmap font.
	 */
	public EnemyStatus(Pokemon pokemon, BitmapFont font, Texture background, Texture healthBars) {
	...
	/**
	 * <p>Updates the {@code EnemyStatus}.</p>
	 * 
	...
	/**
	 * <p>Renders the {@code EnemyStatus}.</p>
	 * 
	...
	public void render(Batch batch, float x, float y) {
		...
		if(perc > 0.5f) {
			batch.draw(highHealth, x+78.0f, y+18.0f, 96.0f*perc, 6.0f);
		} else if(perc > 0.2 && perc <= 0.5f) {
			batch.draw(midHealth, x+78.0f, y+18.0f, 96.0f*perc, 6.0f);
		} else {
			batch.draw(lowHealth, x+78.0f, y+18.0f, 96.0f*perc, 6.0f);
		}
		font.draw(batch, pokemon.getName() +
				(pokemon.getGender() == Gender.MALE ? "\u2642" : "\u2640"), x+12.0f, y+44.0f);
		font.draw(batch, levelLayout, x+getWidth()-levelLayout.width-26.0f, y+44.0f);
	}

	/**
	 * <p>Sets the enemy status pokemon.</p>
	 * 
