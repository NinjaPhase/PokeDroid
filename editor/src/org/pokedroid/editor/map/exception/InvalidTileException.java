package org.pokedroid.editor.map.exception;

/**
 * <p>Thrown if the tile is out of the maps width or height.</p>
 * 
...
public class InvalidTileException extends RuntimeException {
	...
	/**
	 * <p>Constructs a {@code InvalidTileException} with a message.</p>
	 * 
	 * @param s The string.
	 */
	...
	/**
	 * <p>Construct a {@code InvalidTileException} with a pre-defined message.</p>
	 * 
