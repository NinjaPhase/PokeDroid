...
/**
 * <p>A {@code TileMap} is a map that will be edited.</p>
 * 
...
public class TileMap {
	...
	/**
	 * <p>Constructs an empty {@code TileMap}.</p>
	 * 
	...
	/**
	 * <p>Constructs a {@code TileMap} from a JSONObject.</p>
	 * 
	 * @param o The {@code JSONObject}.
	 * @param tilesets The tilesets to get the tileset from.
	 */
	public TileMap(JSONObject o, Map<String, Tileset> tilesets) {
		...
		System.out.println(this.tileset);
	}
	
	/**
	 * <p>Renders a single layer.</p>
	 * 
		...
		for(int y = 0; y < height; y++) {
			for(int x = 0; x < width; x++) {
				if(tiles[layer][x + (y * width)] < 0)
					continue;
				g.drawImage(tileset.getTile(tiles[layer][x+(y * width)]), x*tileset.getWidth(), y*tileset.getHeight(), null);
			}
		}
	}
	
	/**
	 * <p>Gets the {@code TileMap} as a JSON string.</p>
	 * 
	...
	/**
	 * <p>Sets the name of the {@code TileMap}.</p>
	 * 
	...
	/**
	 * <p>Sets the tile at index i on layer l.</p>
	 * 
	 * @param l The layer the tile belongs to.
	 * @param i The index of the tile in the map.
	 * @param tileId The new tile id.
	 * 
	 * @return The old tile id.
	 * 
	 * @throws ArrayIndexOutOfBoundsException Thrown if the tile index is out of bounds.
	 */
	...
	/**
	 * <p>Sets the tile at position x, y on layer l.</p>
	 * 
	 * @param l The layer the tile belongs to.
	 ...
	 * @return The old tile id.
	 * 
	 * @throws ArrayIndexOutOfBoundsException Thrown if the tile layer is out of bounds.
	 * @throws InvalidTileException Thrown if the x or y is out of bounds.
	 */
	...
	/**
	 * <p>Gets the tile at index i on layer l.</p>
	 * 
	 * @param l The layer the tile belongs to.
	...
	/**
	 * <p>Gets the tile at x, y on layer l.</p>
	 * 
	 * @param l The layer the tile belongs to.
	 ...
	 * @return The tile.
	 * 
	 * @throws ArrayIndexOutOfBoundsException Thrown if the layer is out of bounds.
	 * @throws InvalidTileException Thrown if the tile is out of the width or height.
	 */
	...
	/**
	 * <p>Whether the x and y location is a valid location.</p>
	 * 
	...
	/**
	 * <p>Gets the height of the map.</p>
	 * 
	...
	/**
	 * <p>Gets the amount of layers in the map.</p>
	 * 
